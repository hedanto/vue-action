<template>
  <pl-content-box>
    ...
    <pl-content-box-block>
      <p>除了使用Element UI 组件自带 <a class='link' target="_blank" href="http://element.eleme.io/#/zh-CN/component/installation">图标</a> 之外，还引进了Ant Design 的图标,使用方法如下</p>

      <pl-code-box :describe="describe" :html="html">
      ...
      <div class="markdown">
        <ul class="icon_lists clear">
          ...
          <li>
            <i class="icon anticon icon-rollback"></i>
          ...
          <li>
            <i class="icon anticon icon-reload"></i>
          ...
          <li>
            <i class="icon anticon icon-ellipsis"></i>
            <div class="name">ellipsis </div>
            <div class="fontclass">.icon-ellipsis</div>
          </li>

          <li>
            <i class="icon anticon icon-copy"></i>
          ...
          <li>
            <i class="icon anticon icon-folder"></i>
          ...
          <li>
            <i class="icon anticon icon-file"></i>
            <div class="name">file</div>
            <div class="fontclass">.icon-file</div>
          </li>

          <li>
            <i class="icon anticon icon-exception"></i>
          ...
          <li>
            <i class="icon anticon icon-mobile"></i>
          ...
          <li>
            <i class="icon anticon icon-apple"></i>
          ...
          <li>
            <i class="icon anticon icon-aliwangwango"></i>
            <div class="name">aliwangwang-o</div>
            <div class="fontclass">.icon-aliwangwango</div>
          </li>
          ...
          <li>
            <i class="icon anticon icon-jpgfile"></i>
            <div class="name">jpgfile</div>
            <div class="fontclass">.icon-jpgfile</div>
          </li>

          <li>
            <i class="icon anticon icon-like"></i>
            <div class="name">like</div>
            <div class="fontclass">.icon-like</div>
          </li>

          <li>
            <i class="icon anticon icon-dislike"></i>
          ...
          <li>
            <i class="icon anticon icon-message"></i>
          ...
          <li>
            <i class="icon anticon icon-loading"></i>
            <div class="name">loading</div>
            <div class="fontclass">.icon-loading</div>
          </li>

          <li>
            <i class="icon anticon icon-unknowfile"></i>
            <div class="name">unknowfile</div>
            <div class="fontclass">.icon-unknowfile</div>
          </li>

          <li>
            <i class="icon anticon icon-exclefile"></i>
            <div class="name">exclefile</div>
            <div class="fontclass">.icon-exclefile</div>
          </li>

          <li>
            <i class="icon anticon icon-pptfile"></i>
            <div class="name">pptfile</div>
            <div class="fontclass">.icon-pptfile</div>
          </li>

          <li>
            <i class="icon anticon icon-wordfile"></i>
            <div class="name">wordfile</div>
            <div class="fontclass">.icon-wordfile</div>
          </li>

          <li>
            <i class="icon anticon icon-pdffile"></i>
          ...
          <li>
            <i class="icon anticon icon-appleo"></i>
            <div class="name">apple-o</div>
            <div class="fontclass">.icon-appleo</div>
          </li>
          ...
          <li>
            <i class="icon anticon icon-paycircle"></i>
            <div class="name">pay-circle</div>
            <div class="fontclass">.icon-paycircle</div>
          </li>

          <li>
            <i class="icon anticon icon-paycircleo"></i>
            <div class="name">pay-circle-o</div>
            <div class="fontclass">.icon-paycircleo</div>
          </li>

          <li>
            <i class="icon anticon icon-select"></i>
            <div class="name">select</div>
            <div class="fontclass">.icon-select</div>
          </li>

          <li>
            <i class="icon anticon icon-bulb"></i>
